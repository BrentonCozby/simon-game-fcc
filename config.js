...
export const PP = process.env.NODE_ENV === 'production'
    ? '/'
    : '/'
export const SITE_TITLE = 'Simon'
export const SITE_NAME = 'simon-game-fcc'
export const DESCRIPTION = 'Simon game from the 80s built on JavaScript, CSS, and HTML. A Free Code Camp project.'
export const SITE_URL = 'https://d35zt8tt8drw4a.cloudfront.net'
